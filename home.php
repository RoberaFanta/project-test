		...
		<li><a href="#"><strong>LOGIN</strong></a>
         <div class="sub-menu-1">
         	<ul>
         		...
         		<li><a href="index2.html">STUDENT</a></li>
         	</ul>
...
<div class="news-2">
         <p><strong><h1>UPCOMING EVENTS</h1></strong></p>
</div>
        <div class="carde-6">
	...
	<div class="footer-content">
       ...
       <br>SAINT JOSPHE SCHOOL ADAMA
		...
		<div class="footer-section-link">
			<h3>links to our school</h3>
     <li> <i class="fab fa-facebook" aria-hidden="true">face book</i></li>
     <i class="fab fa-facebook"></i>
			
			<a href="facebook.com">tweeter </a>
		</div>
		<div class="footer-section-contact">
			<h3>you can contact us </h3>
			<p>phone  0978654356</p>
			<p>email  bksebsibe55@gmail.com</p>
		</div>
